...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
  ...
  /*      layout.headerReferenceSize = CGSize(width: fullScreenSize.width, height: 40)
        ...
        myCollectionView.register(MyNewCollectionViewCell.self,
    ...
    func NewcollectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) ->   UICollectionViewCell {
       ...
       newCell.imageView.image = UIImage(named: "0\(indexPath.item + 3).jpg")   //
     /*   newCell.nameLabel.text = "篮球场 "
        newCell.myTextView.text = "Swift 起步走123456\n7889"
        newCell.snapkitTestView.image = UIImage(named: "04.jpg")
        newCell.snapkitTestView2.image = UIImage(named: "06.jpg")
 */ 
        return newCell
    }
